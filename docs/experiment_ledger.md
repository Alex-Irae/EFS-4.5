...
The authoritative scientific hypothesis remains [`h45_project.md`](h45_project.md). This ledger also absorbs the former development log, so the repository has one experiment history.
