...
From `E:\Desktop\AnewOmni\4.5hypothesis`:
...
- `legacy\separate_field\`;
- `legacy\single_plane_prototype\`.
...
The authoritative project hypothesis is `E:\Desktop\AnewOmni\EFS_AnewOmni_Hypothesis_4_5_Project.md`.
